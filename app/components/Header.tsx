    ...
    return (
        <header className={styles.container}>
            ...
            <section className={styles.switches}>
                ...
                {lang == "en" ? <span title='to pt-br' onClick={() => changeLangTo("br")}>en</span> : <span title='to en-us' onClick={() => changeLangTo("en")}>br</span>}
                </section>
                <section className={styles.theme}>
                    {theme == "dark" ? <FiMoon size='1rem' title='to light' onClick={() => changeThemeTo("light")}/> : <FiSun size='1rem' title='to dark' onClick={() => changeThemeTo("dark")}/>}
                </section>
            </section>
        </header>
    )
